...
Unités et composants permettant d'étendre les fonctionnalités de Skia et Skia4Delphi dans vos projects VCL et FireMonkey.
...
Pour télécharger ce dépôt de code il est recommandé de passer par "git" mais vous pouvez aussi télécharger un ZIP directement depuis [son dépôt GitHub](https://github.com/DeveloppeurPascal/Delphi-SkiaExtend-Library).
...
L'export de la documentation est fait en HTML par [DocInsight](https://devjetsoftware.com/products/documentation-insight/) ou [PasDoc](https://pasdoc.github.io) vers le dossier /docs du dépôt. Vous y avez aussi [accès en ligne](https://developpeurpascal.github.io/Delphi-SkiaExtend-Library) grâce à l'hébergement offert par GitHub Pages.

D'autres informations (tutoriels, articles, vidéos, FAQ, présentations et liens) sont disponibles sur [le site web du projet](https://skiaextend.developpeur-pascal.fr/) ou [le devlog du projet](https://developpeur-pascal.fr/skia-extend-library.html).
...
Si vous détectez des anomalies sur des versions antérieures n'hésitez pas à [les rapporter](https://github.com/DeveloppeurPascal/Delphi-SkiaExtend-Library/issues) pour que je teste et tente de corriger ou fournir un contournement.
...
Si cette licence ne convient pas à vos besoins (notamment pour un projet commercial) je propose aussi [des licences classiques pour les développeurs et les entreprises](https://skiaextend.developpeur-pascal.fr/).
...
Si vous voulez une réponse du propriétaire de ce dépôt la meilleure façon de procéder pour demander une nouvelle fonctionnalité ou signaler une anomalie est d'aller sur [le dépôt de code sur GitHub](https://github.com/DeveloppeurPascal/Delphi-SkiaExtend-Library) et [d'ouvrir un ticket](https://github.com/DeveloppeurPascal/Delphi-SkiaExtend-Library/issues).
